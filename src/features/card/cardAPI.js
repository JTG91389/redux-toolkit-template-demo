...
const randomAnimalCards = {
  ...
  5: {
    ...
    message:
      'A Blue Whales tongue can weigh as much as a car, or a small adult elephant, weighing around 2,720-3,630 Kg.',
  },
  6: {
  ...
  9: {
    ...
    message:
      'The smell of a skunk is powerful enough for a human to smell it up to 5.6 km away.',
  },
};
...
export function fetchCard() {
  return new Promise((resolve) =>
    setTimeout(
      () =>
        resolve({
          data: randomAnimalCards[Math.floor(Math.random() * 10)],
        }),
      1000
    )
  );
